...
/* Includes ---------------------------------------------------------------- */
#include <VocapraDef_Merged_Labels_inferencing.h>
#include <PDM.h>
...
void print_inference_result(ei_impulse_result_t result) {
    ...
    for (uint16_t i = 0; i < EI_CLASSIFIER_LABEL_COUNT; i++) {
        ...
        if(massimo< result.classification[i].value){
          massimo = result.classification[i].value;
          massi = String(ei_classifier_inferencing_categories[i]);
          //ei_printf("massimo\n");
        }        
    }
    ...
    String accuracy = String(massimo);
    String label = massi;
